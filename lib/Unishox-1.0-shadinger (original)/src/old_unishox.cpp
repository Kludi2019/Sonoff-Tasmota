...
int32_t old_unishox_compress(const char *in, size_t len, char *out, size_t len_out) {
...
int32_t old_unishox_decompress(const char *in, size_t len, char *out, size_t len_out) {
